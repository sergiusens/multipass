...
mp::DelayedShutdownTimer::DelayedShutdownTimer(VirtualMachine* virtual_machine, std::chrono::milliseconds delay)
    : virtual_machine{virtual_machine}, delay{delay}
{
    start_timer();
}
...
void mp::DelayedShutdownTimer::start_timer()
{
